                            ...
                            <div class="col-md-7">
                                ...
                                <form id="form" action="" method="GET">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" class="form-control" id="fileInput" onclick="importfromExcel()" accept=".xlsx"  />
                                        <button type="submit" class="btn btn-primary" id="fileImport">Importálás Excelből</button>
                                    </div>
                                </form>
